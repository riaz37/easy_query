...
gemini_apikey = os.getenv("google_api_key_gemini")
if gemini_apikey is None:
    print("Warning: 'google_api_key_gemini' not found in environment variables.")

gemini_model_name = os.getenv("gemini_model_name", "gemini-1.5-pro")
if gemini_model_name is None:
    print("Warning: 'gemini_model_name' not found in environment variables, using default 'gemini-1.5-pro'.")
