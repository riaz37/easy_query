...
from app.unstructured.agent.data_structizer_agent_v1 import DocumentProcessingPipeline, FileMetadata, ChunkMetadata, create_pipeline
        ...
        try:
            ...
            with self.get_connection() as conn:
                ...
                INSERT INTO document_chunks (
                    ...
                    date_range, chunk_order, embedding, combined_context, combined_embedding
                ) VALUES (
...
class DocumentDatabasePipeline:
    ...
    def process_and_store_document(self, file_path: str, output_dir: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            file_metadata, chunk_metadata_list = self.processing_pipeline.process_document(file_path, output_dir)
...
import logging
from  app.unstructured.agent.data_structizer_agent_v1  import SmartDocumentProcessor, SmartTextChunker, llm
...
def data_save(
    ...
    try:
        ...
        result = pipeline.process_and_store_document(file_path, "processing_results")
...
if __name__ == "__main__":
    # Example usage
    data_save(file_path=r"/Users/nilab/Desktop/projects/Knowladge-Base/S65C-0i24120816010-1 copy.pdf")
