...
class LLMProcessor:
    ...
    def generate_chunk_metadata(self, chunk_text: str, chunk_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Error generating chunk metadata for {chunk_id}: {e}")
            return {
                "summary": f"Chunk summary unavailable: {str(e)}",
...
class DocumentProcessingPipeline:
    ...
    def process_document(self, file_path: str, output_dir: Optional[str] = None) -> Tuple[FileMetadata, List[ChunkMetadata]]:
        """
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            for i, chunk in enumerate(chunks):
                ...
                if isinstance(chunk, str):
                    ...
                    # If chunk is an object, try to extract text
                ...
                chunk_futures[chunk_id] = (future, chunk_text)
            ...
            for chunk_id, (future, chunk_text) in chunk_futures.items():
                try:
                    ...
                    # Create fallback chunk metadata
                    chunk_metadata = ChunkMetadata(
                        file_id=file_id,
                        chunk_id=chunk_id,
                        chunk_text=chunk_text,
