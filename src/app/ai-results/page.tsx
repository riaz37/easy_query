    ...
    if (storedResults) {
      try {
        ...
        console.log("AI Results Page - Results structure:", {
          ...
          hasLLMAnalysis: results.results?.some(
            (section: any) => section.graph_and_analysis?.llm_analysis
          ),
        ...
        description={
          <>
            ...
            {reportResults.results &&
              reportResults.results.some(
                (section) => section.graph_and_analysis?.llm_analysis
              ) && (
