...
export default function AIResultsPage() {
  ...
  if (!reportResults) {
    return (
      <PageLayout background="enhanced" maxWidth="4xl" backgroundIntensity="high">
                  ...
                  <div className="pt-12 pb-12 text-center">
                    ...
                    <p className="text-gray-400">
                      ...
                      {reportResults.successful_queries > 0 && (
                        <span className="text-emerald-400"> {reportResults.successful_queries} queries were successful.</span>
                      )}
                    </p>
                  </div>
                </div>
