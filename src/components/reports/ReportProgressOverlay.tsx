...
export function ReportProgressOverlay({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-gray-900/95 border border-emerald-400/30 rounded-2xl p-8 max-w-md w-full mx-4">
        <div className="text-center space-y-6">
          {/* Animated Brain Icon */}
          <div className="relative">
            <div className="w-20 h-20 bg-gradient-to-br from-emerald-500/20 to-emerald-500/20 rounded-full flex items-center justify-center mx-auto border border-emerald-400/30">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              <span className="text-emerald-400">Generating Report</span>
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            ...
            <div className="text-center">
              <div className="text-emerald-400 font-medium">Step</div>
