                ...
                <thead>
                  ...
                  >
                    <th className="px-6 py-4 text-left rounded-tl-xl">
                      <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-32")} />
                    </th>
                    <th className="px-6 py-4 text-left">
                      <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-20")} />
                    </th>
                    <th className="px-6 py-4 text-left">
                      <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-16")} />
                    </th>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="space-y-2">
                          <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-48")} />
                          <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-32")} />
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="space-y-1">
                          <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-24")} />
                          <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-16")} />
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className={cn("bg-gray-200 dark:bg-gray-700 rounded animate-pulse", cellHeight, "w-8")} />
                      </td>
