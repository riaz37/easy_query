...
export class QueryService extends BaseService {
  ...
  async query(params: DbQueryParams): Promise<ServiceResponse<QueryResultData>> {
    ...
    console.log("QueryService - Parameters:", { question: params.question, user_id: params.userId }); // Debug log
   ...
   */
  async sendDatabaseQuery(question: string, userId: string): Promise<ServiceResponse<QueryResultData>> {
